package com.allvideodownloader.hdvideodownloader.securevideosaver.presentation.screens.onBoarding.states
...
data class OnboardingState(
    ...
    val isPremiumPageVisible: Boolean = true,
...
fun buildOnboardingPages(
    ...
    val shouldShowFullNativePage = !isPremiumUser && nativeAdConfig.placement(NativeAdConfig.ONBOARDING_STEP_4) != null
