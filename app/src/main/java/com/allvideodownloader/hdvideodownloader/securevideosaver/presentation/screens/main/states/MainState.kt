...
data class MainState(
    ...
    val mediaPlaybackState: MediaPlaybackState = MediaPlaybackState(),
    val floatingVideoMiniPlayerState: FloatingVideoMiniPlayerState = FloatingVideoMiniPlayerState(),
)