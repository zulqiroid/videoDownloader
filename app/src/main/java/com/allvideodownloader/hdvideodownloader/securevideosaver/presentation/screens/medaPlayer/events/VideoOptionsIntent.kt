...
sealed interface VideoOptionsIntent {
    ...
    data object OnAudioEffectsClicked : VideoOptionsIntent

    data object OnAudioEffectsDismissed : VideoOptionsIntent
    ...
    data class OnEqualizerPresetSelected(
        val presetIndex: Short
    ) : VideoOptionsIntent

    data class OnBassBoostEnabledChanged(
        val enabled: Boolean
    ) : VideoOptionsIntent

    data class OnBassBoostStrengthChanged(
        val strength: Short
    ) : VideoOptionsIntent
}