...
import com.allvideodownloader.hdvideodownloader.securevideosaver.domain.model.ads.NativeAdConfig.Companion.TEST_NATIVE_AD_UNIT_ID
...
data class NativeAdConfig(
    ...
    companion object {
        ...
        const val TEST_NATIVE_AD_UNIT_ID = ""
        ...
        const val MORE= "more"
        const val DOWNLOAD_GUIDE = "download_guide"
        ...
        fun defaultPlacements(): Map<String, NativeAdPlacementConfig> {
            return mapOf(
                SPLASH to NativeAdPlacementConfig(
                    enabled = true,
                ...
                HOME to NativeAdPlacementConfig(
                    enabled = true,
                    style = NativeAdStyle.Small,
                    position = NativeAdPosition.Bottom,
                    showPlaceholder = true,
                ),
                REELS to NativeAdPlacementConfig(
                    enabled = true,
                    style = NativeAdStyle.Small,
                    position = NativeAdPosition.Bottom,
                    showPlaceholder = true,
                ...
                MORE to NativeAdPlacementConfig(
                    enabled = true,
                    style = NativeAdStyle.Small,
                    position = NativeAdPosition.Top,
                    showPlaceholder = true,
                ...
                DOWNLOAD_LIST to NativeAdPlacementConfig(
                    enabled = true,
                    style = NativeAdStyle.Small,
                    position = NativeAdPosition.Bottom,
                    showPlaceholder = true,
                ),
                DOWNLOAD_GUIDE to NativeAdPlacementConfig(
                    enabled = true,
                    style = NativeAdStyle.Small,
                    position = NativeAdPosition.Bottom,
                    showPlaceholder = true,
